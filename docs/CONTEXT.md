...
**Current Task:** Enhancement 2 - pricing UI refactor for public landing and `/app/billing`

หมายเหตุ: รอบนี้ปิดงาน pricing UI refactor ครบทั้งหน้า public และหน้า billing dashboard โดยใช้ 3-tier comparison matrix บน landing page, monthly/yearly toggle กลาง section และ toggle เดียวบน `/app/billing` ที่เปลี่ยนราคา label ปุ่มและ checkout price id ตามรอบบิลแบบ reactive
...
| `src/components/guest/guest-workspace.tsx` | Landing page UI แสดงคำอธิบายเว็บไซต์และปุ่มสลับ Theme สี แทนการใช้งาน Guest Editor เดิม |
