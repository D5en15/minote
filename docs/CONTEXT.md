...
**Current Task:** Redesign guest landing page to use a centered Hero layout with features introduction and price options card links

หมายเหตุ: ปรับดีไซน์หน้าแรก (Landing page) ให้เป็นสไตล์ Hero Section ตรงกลางที่ดูพรีเมียม แสดงฟีเจอร์เด่น แผนการให้บริการ (Pricing cards: Free, Pro) พร้อมปุ่มคีย์เวิร์ดเรียกฟอร์มล็อกอินผ่าน Popup modal ครบถ้วนเสร็จสมบูรณ์เรียบร้อยแล้ว
