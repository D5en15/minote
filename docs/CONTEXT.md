...
**Current Task:** Enhancement 3 - public landing pricing cards redesign

หมายเหตุ: รอบนี้ refactor หน้า public pricing จาก comparison matrix กลับเป็น 3-column pricing cards (Zen Free, Zen Pro, Zen Studio) โดยคง monthly/yearly toggle, checkout price-id switching และ visual language เดียวกับ billing dashboard
