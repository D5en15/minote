...
เริ่ม Phase 13 Billing & Subscription

**Current Task:** 13.1 สร้าง Stripe client helper

หมายเหตุ: ระบบ Markdown Export สามารถทำงานและผ่านการทดสอบ verify-phase12 แบบ end-to-end เรียบร้อยแล้ว ลำดับถัดไปคือเริ่มโมดูล Stripe และระบบสมัครสมาชิก (Billing)
