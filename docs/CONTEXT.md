...
**Current Task:** Refactor guest landing page introduction and remove old import guest notes prompt banner from cloud app workspace

หมายเหตุ: ปรับโครงสร้างหน้าแรก (Landing page) ให้เป็นข้อมูลแนะนำเว็บไซต์แทนการใช้งานแบบ Guest Draft Editor และติดตั้งตัวเลือกสลับ Theme สี พร้อมลบ Banner และ Modal แจ้งเตือนข้อความนำเข้าบันทึก "Import guest notes?" ในส่วนระบบหลังบ้านเรียบร้อยแล้ว เพื่อความปลอดภัยและเป็นระบบระเบียบยิ่งขึ้น
